...
import 'package:tasca4/bloc/oratge_gloc.dart';
import 'package:tasca4/repository/comarques_repository.dart';
...
class ComarquesBloc {
  ...
  // Una cadena amb la província de la qual s’estan mostrant les comarques en un moment donat (String? _provinciaActual)

  String? _provinciaActual;

  //La llista de comarques de la província actual (List<dynamic>? _llistaComarques)

  List<dynamic>? _llistaComarques;

  //El nom de la comarca de què s’està mostrant informació en un moment donat (String? _nomComarcaActual)

  String? _nomComarcaActual;

  //La informació completa sobre la comarca actual (Comarca? comarcaActual).
...
// sobre la comarca (la pestanya general).
  ...
  void carregaComarca(String comarca) async {
    ...
    // NOU: Proporcionem al BloC de l'oratge aquesta comarca
    OratgeBloc().comarcaActual = comarcaActual;
  }
